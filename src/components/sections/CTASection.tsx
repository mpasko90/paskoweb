      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-xl mb-8 text-blue-100 leading-relaxed">
            Skontaktuj się ze mną już dziś i otrzymaj bezpłatną wycenę swojego projektu. 
            Stworzę dla Ciebie nowoczesną stronę internetową, która będzie wyróżniać się na rynku.
          </p>
          
          <div className="grid md:grid-cols-3 gap-6 mb-10">
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
              <CardContent className="p-6 text-center">
                <div className="text-2xl font-bold text-blue-200 mb-2">24h</div>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
              <CardContent className="p-6 text-center">
                <div className="text-2xl font-bold text-blue-200 mb-2">10+</div>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
              <CardContent className="p-6 text-center">
                <div className="text-2xl font-bold text-blue-200 mb-2">50+</div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-white text-white hover:bg-white hover:text-blue-600 shadow-xl hover:shadow-2xl transition-all duration-300 px-8 py-4 text-lg font-semibold"
            >
              <Link href="tel:+48881711211">
                Zadzwoń: 881 711 211
              </Link>
            </Button>
          </div>
          ...
          <div className="mt-8 text-blue-100 text-sm">
            <p>✅ Bezpłatna konsultacja ✅ Transparentne ceny ✅ Terminowa realizacja</p>
          </div>
        </div>
      </div>
    </section>
